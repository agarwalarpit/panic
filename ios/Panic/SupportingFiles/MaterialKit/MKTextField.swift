...
@objc public protocol MKTextFieldDelegate {
    optional func didTextFieldDelete()
}

@IBDesignable
public class MKTextField : UITextField {
    
    public var mkDelegate: MKTextFieldDelegate!
    ...
    // Catch the deleteBackward button
    
    public override func deleteBackward() {
        
        super.deleteBackward()
        
        if let item = mkDelegate {
            item.didTextFieldDelete!()
        }
    }
